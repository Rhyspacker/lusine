...
// Custom fields
$latestReleaseTitle = get_post_meta($post->ID, 'latest release title', true);
$latestReleaseListen = get_post_meta($post->ID, 'latest release listen link', true);
$latestReleaseBuy = get_post_meta($post->ID, 'latest release buy link', true);
$latestReleaseImg = wp_get_attachment_url( get_post_thumbnail_id($post->ID), 'thumbnail' );
	...
	<header class="header">
		<div class="header__wpr">
			...
			<ul class="header__nav">
				...
				<li class="header__nav__li"><a href="<?php echo esc_url( get_permalink( get_page_by_title( 'News' ) ) ); ?>">News</a></li>
				<li class="header__nav__li"><a href="/work">Work</a></li>
				<li class="header__nav__li"><a href="/live-dates">Live Dates</a></li>
				<li class="header__nav__li"><a href="/press">Press</a></li>
				<li class="header__nav__li"><a href="/contact">Contact</a></li>
			</ul>
  ...
  <div class="hero__content text--center-tablet-down mt-2-tablet-down">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="h1 mb-1 text--uppercase"><?php echo $latestReleaseTitle ?></h1>
